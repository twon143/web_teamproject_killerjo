					...
					<div class="logined-form">
						<div class="right-float-div">
							...
							<form action="user/logout" method="post">
								<input type="submit" onclick="" class="btn-logout btn btn-info" value="로그아웃" />
								...
								<div class="sub-post-list">
									<div class="post-image-div">
										<c:if test="${board.type == 'question'}">
											<a href="/teamproject/board/readPaging${pageMaker.makeQuery(pageMaker.criteria.page)}&bno=${board.bno}&category=${category}&type=${type}"> <img class="post-image" alt="" src="/teamproject/resources/images/blank_image.png">
											</a>
										</c:if>
										<c:if test="${board.type == 'writing'}">
											<a href="/teamproject/board/readPaging${pageMaker.makeQuery(pageMaker.criteria.page)}&bno=${board.bno}&category=${category}&type=${type}"> <img class="post-image" alt="" src="/teamproject/resources/images/writing_image.png">
											</a>
										</c:if>
										<c:if test="${board.type == 'link'}">
											<a href="/teamproject/board/readPaging${pageMaker.makeQuery(pageMaker.criteria.page)}&bno=${board.bno}&category=${category}&type=${type}"> <img class="post-image" alt="" src="/teamproject/resources/images/link_image.png">
											</a>
										</c:if>
									</div>
								...
								<ul class="pagination">
									...
									<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
										<li<%-- <c:out value="${pageMaker.criteria.page == idx ? 'class=active' : ''}"/> --%>>
											<%-- <a href="/teamproject/board/listPaging?page=${idx}">${idx}</a> --%> <a href="/teamproject/board/listPaging${pageMaker.makeQuery(idx)}&category=${category}&type=${type}">${idx}</a>
										</li>
									</c:forEach>
