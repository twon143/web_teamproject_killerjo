...
<body>
							...
							<div class="left-body-div">
								<div class="form-group">
									<label class="id-label">아이디</label> <br /> <input
										class="register-id-form" type="text" id="id" name="id"
								...
								<div class="form-group">
									<label class="pw-label">비밀번호</label> <br /> <input
										class="register-pw-form" type="password" id="password" name="password"
										placeholder="비밀번호 입력" />
								...
								<div class="form-group">
									<label class="check-pw-label">비밀번호 확인</label> <br /> <input
										class="register-check-pw-form" type="password" id="password1"
								...
								<div class="form-group">
									<label class="email-label">이메일</label> <br /> <input
										class="register-email-form" type="email" placeholder="이메일 입력" name="email"/>
					...
					<div class="section-right">
						...
						<div class="right-body-div">
							...
							<form action="login-post" method="post">
								<div class="form-group">
									<label class="id-label">아이디</label> <br /> <input
										class="login-id-form" type="text" name="id"/>
								</div>
	
								<div class="form-group">
									<label class="pw-label">비밀번호</label> <br /> <input
										class="login-pw-form" type="password" name="password"/>
								</div>
	...
	<script>
		...
		function submitCheck() {
			var test = $('[name=whether-checked]').is(':checked');
			var checkedBox = 0;
			if (test == true) {
				checkedBox = 1;
			} else {
