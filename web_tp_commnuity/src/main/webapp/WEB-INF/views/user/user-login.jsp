			...
			<div class="row">
				...
				<div class="col-sm-10">
					<div class="info">
						...
						<p class="p-info p1">로그인을 해야만 이용할 수 있는 기능입니다.</p> <br/>
						<p class="p-info p2">간단하게 회원가입하거나 로그인해서 이용하실 수 있습니다.<p>
					</div>
					...
					<div class="section-left">
						...
						<div class="left-body-div">
							<div class="form-group">
								...
								<br/>
								<input class="register-id-form" type="text" placeholder="8~15자리 영문 숫자로만"/>
							</div>
							
							<div class="form-group">
								<label class="pw-label">비밀번호</label>
								<br/>
								<input class="register-pw-form" type="text" placeholder="비밀번호 입력"/>
							</div>
							
							<div class="form-group">
								<label class="check-pw-label">비밀번호 확인</label>
								<br/>
								<input class="register-check-pw-form" type="text" placeholder="비밀번호를 다시 입력"/>
							</div>
							
							<div class="form-group">
								<label class="nickname-label">닉네임</label>
								<br/>
								<input class="register-nickname-form" type="text" placeholder="2자 이상"/>
							</div>
							
							<div class="form-group">
								<label class="email-label">이메일</label>
								<br/>
								<input class="register-email-form" type="text" placeholder="이메일 입력"/>
								<p class="email-info-p">입력하신 이메일로 인증 메일이 발송됩니다</p>
							</div>
							
							<div class="checkBox-div">
								<label class="lbl-term">
					...
					<div class="section-right">
						...
						<div class="right-body-div">
							<div class="form-group">
								<label class="id-label">아이디</label>
								<br/>
								<input class="login-id-form" type="text"/>
							</div>
							
							<div class="form-group">
								<label class="pw-label">비밀번호</label>
								<br/>
								<input class="login-pw-form" type="text"/>
							</div>
							
							<input type="submit" value="로그인" class="btn-login"/>
							<a href="#" class="a-findPw">비밀번호를 분실하셨나요?</a>
							<hr>
